...
CREATE INDEX IF NOT EXISTS IDX_VEHICLE_CRASH_ID ON VEHICLE_TBL (VEH_CRASH_ID);
...
CREATE INDEX IF NOT EXISTS IDX_CWC_CRASH_ID ON CRASH_WEATHER_CONDITION_TBL (CWC_CRASH_ID);
...
CREATE INDEX IF NOT EXISTS IDX_CSC_CRASH_ID ON CRASH_SURFACE_CONDITION_TBL (CSC_CRASH_ID);
...
CREATE INDEX IF NOT EXISTS IDX_CCR_CRASH_ID ON CRASH_CONTRIBUTING_ROADWAY_TBL (CCR_CRASH_ID);
...
CREATE INDEX IF NOT EXISTS IDX_VTC_VEHICLE_ID ON VEHICLE_TRAFFIC_CONTROL_TBL (VTC_VEHICLE_ID);
...
CREATE INDEX IF NOT EXISTS IDX_VDA_VEHICLE_ID ON VEHICLE_DAMAGE_AREA_TBL (VDA_VEHICLE_ID);
...
CREATE INDEX IF NOT EXISTS IDX_VSE_VEHICLE_ID ON VEHICLE_SEQUENCE_EVENT_TBL (VSE_VEHICLE_ID);
...
CREATE INDEX IF NOT EXISTS IDX_CAL_CRASH_ID ON CRASH_AUDIT_LOG_TBL (CAL_CRASH_ID);
CREATE INDEX IF NOT EXISTS IDX_CAL_ACTION   ON CRASH_AUDIT_LOG_TBL (CAL_ACTION_CODE);
